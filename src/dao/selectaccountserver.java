...
import java.sql.*;
			...
			public class selectaccountserver extends HttpServlet {
			    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			        String account=req.getParameter("account");
			    	try { 
			        	 
			        	  Connection conn=sqlutill.getConn();
			              String sql1="select * from user where account="+account+" or name="+account;
			              String sql2="select * from shoptaker where account="+account+" or name="+account;
			              String sql3="select * from good where id="+account+" or name="+account;
