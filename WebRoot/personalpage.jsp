...
名字：${user.name} 		<input type="text" name="name">
...
地址：${user.address}		<input type="text" name="address">

电话：${user.phone}		<input type="text" name="phone">

email：${user.email}   		<input type="text" name="email">
...
<a href="accountloginout.jsp" class="btn btn-default">退出登陆</a>
  ...
  <div class="btn-group btn-group-justified">
    <a href="#" class="btn btn-default"><span class="glyphicon glyphicon-list-alt"></span> 订单</a>
    <a href="#" class="btn btn-default"><span class="glyphicon glyphicon-usd"></span> 未支付订单</a>
    <a href="#" class="btn btn-default"><span class="glyphicon glyphicon-envelope"></span> 评价</a>
  </div>
