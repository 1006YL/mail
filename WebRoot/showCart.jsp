...
<tbody>
   <%
	...
	<%=good.getName()%>
		...
		<td><a href="/sxgcnew/servlet/RemoveServlet?goodid=<%=good.getId()%>">删除</a></td>
		</tr>
	<%
		}			
   %>
   ...
   <pre>
   <a href="shopallshow.jsp" class="btn btn-default">继续买书</a>   <a href="servlet/inputorderserver"  class="btn btn-default">付款结算</a>
   </pre>
